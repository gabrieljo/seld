	...
	<div class="row">
		<div class="col-sm-3 col-sm-offset-1">
			...
			<div class="form-group form-group-sm col-sm-10">
				...
				echo form_dropdown('set-cutting', $options, @$form['set-cutting'], 'class="form-control input-xs" id="set-cutting"');
				?>
			</div>
			<div class="form-group form-group-sm col-sm-10">
				...
				echo form_dropdown('set-quantity', $options, @$form['set-quantity'], 'class="form-control input-xs" id="set-quantity"');
				?>
			</div>
		</div>
		<div class="col-sm-3 nopadding">
			...
			<div class="form-group form-group-sm col-sm-10">
				...
				echo form_dropdown('set-printing', $options, @$form['set-printing'], 'class="form-control input-xs" id="set-printing"');
				?>
			</div>
			<div class="form-group form-group-sm col-sm-10">
				...
				echo form_dropdown('set-frequency', $options, @$form['set-frequency'], 'class="form-control input-xs" id="set-frequency"');
				?>
			</div>
			<div class="form-group form-group-sm col-sm-10">
				...
				echo form_dropdown('set-quality', $options, @$form['set-quality'], 'class="form-control input-xs" id="set-quality"');
				?>
			</div>
		</div>
		<div class="col-sm-4 col-sm-offset-0">
			...
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-6">
					...
					echo form_dropdown('set-coating', $options, @$form['set-coating'], 'class="form-control input-xs" id="set-coating"');
					?>
				</div>
			</div>
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-6">
					...
					echo form_dropdown('set-folding', $options, @$form['set-folding'], 'class="form-control input-xs" id="set-folding"');
					?>
				</div>
			</div>
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-6">
					...
					echo form_dropdown('set-folding2', $options, @$form['set-folding2'], 'class="form-control input-xs" id="set-folding2"');
					?>
				</div>
			</div>
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-6">
					...
					echo form_dropdown('set-dotted', $options, @$form['set-dotted'], 'class="form-control input-xs" id="set-dotted"');
					?>
				</div>
			</div>
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-6">
					...
					echo form_dropdown('set-holes', $options, @$form['set-holes'], 'class="form-control input-xs" id="set-holes"');
					$options = array(
									'3 mm' 	=> '3 mm',
									'4 mm' 	=> '4 mm',
									'5 mm' 	=> '5 mm',
					...
					echo form_dropdown('set-holes-size', $options, @$form['set-holes-size'], 'class="form-control input-xs" id="set-holes-size"');
					?>
				</div>
			</div>
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-6">
					<?php
					$ck = @$form['set-tolling'] == '1' ? TRUE : FALSE;
					echo form_checkbox('set-tolling', '1', $ck);
					?> Yes
				</div>
			</div>
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-6">
					<?php
					$ck = @$form['set-painting'] == '1' ? TRUE : FALSE;
					echo form_checkbox('set-painting', '1', $ck);
					?> Yes 
				</div>
			</div>
		</div>
