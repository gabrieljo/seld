...
<div class="container-fluid">
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<?=anchor('m/designs', '<span class="glyphicon glyphicon-triangle-left"></span> My Designs', array('class'=>'btn btn-danger btn-xs pull-left', 'style'=>'padding: 5px 10px;margin:8px 0px 0 10px;'))?>
	</div><!-- /.navbar-collapse -->
</div><!-- /.container-fluid -->
</div>
