...
<div class="col-sm-9">
	...
	<?=anchor('u/create', '디자인 하기', array('class'=>'btn btn-success'))?> <br><br><br>
	<?=anchor('u/create', '내가 주문한 디자인', array('class'=>'btn btn-info'))?> <br><br><br>
	<?=anchor('u/create', '내가 저장한 디자인', array('class'=>'btn btn-primary'))?>
</div>
