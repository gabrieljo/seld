...
/*
 * this is custom form_dropdown.
 * check the value for auto-checking or leave as it is
 */
if ( ! function_exists('form_ckbox')){
	function form_ckbox($name, $value, $status){
		$check = $status == '1' ? TRUE : FALSE;
		return form_checkbox($name, $value, $check);
	}
}
